            ...
            <div class="row">
                    ...
                    <div class="product-gallery">
                        <div class="product-gallery-preview order-sm-2">
                            ...
                            foreach ($images as $key => $image) {
                                ?>
                                <div class="product-gallery-preview-item <?=$active?>" id="img-<?= $key?>"><img class="image-zoom"
                                        src="<?= $image->thumb ?>" data-zoom="<?= $image->src ?>" alt="Product image">
                ...
                <div class="col-lg-5 pt-4 pt-lg-0">
                    <div class="product-details ms-auto pb-3">
                        ...
                        <div class="mb-3"><span class="h3 fw-normal text-accent me-1">NPR <?=$product['selling_price']?>.<small>99</small></span>
                        </div>
                        <div class="position-relative me-n4 mb-3">
                            <div class="product-badge product-available mt-n1"><i class="ci-security-check"></i>Product
                                available</div>
                        </div>
                        <form class="mb-grid-gutter" action="cart-process-add.php" method="post">
                            ...
                            <div class="accordion-item">
                                <h3 class="accordion-header"><a class="accordion-button collapsed" href="#localStore"
                                        ...
                                        aria-controls="localStore"><i
                                            class="ci-location text-muted fs-lg align-middle mt-n1 me-2"></i>Find in
                                        local store</a></h3>
            ...
            <div class="col-md-7">
                ...
                <div class="product-review pb-4 mb-4 border-bottom">
                    ...
                    <ul class="list-unstyled fs-ms pt-1">
                        <li class="mb-1"><span class="fw-medium">Pros:&nbsp;</span>Consequuntur magni, voluptatem sequi,
                            tempora</li>
