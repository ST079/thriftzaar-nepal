...
protected_area();
//fetch categories
$categories = db_select("categories", '1 ORDER BY c_id DESC');
// echo"<pre>";
// print_r($categories);
// die();
...
<div class="page-title-overlap bg-dark pt-4">
    <div class="container d-lg-flex justify-content-between py-2 py-lg-3">
        ...
        <div class="order-lg-1 pe-lg-4 text-center text-lg-start">
            <h1 class="h3 text-light mb-0">My Categories</h1>
        </div>
    </div>
</div>
    ...
    <div class="row">
        ...
        <section class="col-lg-8">
            ...
            <div class="d-flex justify-content-between align-items-center pt-lg-2 pb-4 pb-lg-5 mb-lg-3">
                <a class="btn btn-warning btn-sm d-none d-lg-inline-block"
                    href="<?= url("/admin-categories-add.php") ?>">
                    <i class="fa-solid fa-plus me-2"></i>Add Product Category</a>
