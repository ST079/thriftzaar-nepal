...
$contacts = db_select("contacts", null, "created_at DESC");
?>
    ...
    <div class="row">
        ...
        <section class="col-lg-8">
            ...
            <div class="d-flex justify-content-between align-items-center pt-lg-2 pb-4 pb-lg-5 mb-lg-3">
                <p class="mb-0 h5">Total: <?= count($contacts) ?></p>
                ...
                <div class="pt-2 px-4 ps-lg-0 pe-xl-5">
                    <div class="d-sm-flex flex-wrap justify-content-between align-items-center border-bottom">
                        <h2 class="h3 py-2 me-2 text-center text-sm-start">All Messages<span
                                class="badge bg-faded-accent fs-sm text-body align-middle ms-2"><?= count($contacts) ?></span>
                        </h2>
                    </div>
                    ...
                    <?php else: ?>
                        <div class="row g-3 mt-3">
                            <?php foreach ($contacts as $inquiry): ?>
                                        ...
                                        <div class="card-body">
                                            ...
                                            <div class="d-flex justify-content-between align-items-center">
                                                ...
                                                <button class="btn btn-sm btn-outline-danger delete-btn"
                                                    data-id="<?= $inquiry['id'] ?>" data-table="contacts">
