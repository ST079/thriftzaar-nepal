...
!(function () {
  ...
  (null != (r = document.querySelector(".navbar-sticky")) &&
    ...
    (function () {
      for (
        var e = document.querySelectorAll(".file-drop-area"), t = 0;
        t < e.length;
        t++
      )
        !(function () {
                  ...
                  ((o.innerHTML = r),
                    e.startsWith("data:image")
                      ...
                      : e.startsWith("data:video")
                        ? ((a.innerHTML = ""),
                          (a.className = ""),
                          (a.className = "file-drop-icon ci-video"))
                        : ((a.innerHTML = ""),
                          (a.className = ""),
      ...
      if (0 !== e.length || 0 !== t.length || 0 !== a.length) {
        ...
        for (var p = 0; p < t.length; p++) {
          var m,
            ...
            g =
              null != t[p].dataset.options
                ? JSON.parse(t[p].dataset.options)
                : "",
    ...
    (function () {
      for (
        var a = document.querySelectorAll(".range-slider"), l = 0;
        l < a.length;
        l++
      )
        !(function () {
    ...
    (function () {
      for (
        var e = document.querySelectorAll(".widget-filter"), t = 0;
        t < e.length;
        t++
      )
        (function () {
      ...
      if (0 !== e.length)
        for (var t = 0; t < e.length; t++) {
          ...
          var n = e[t].classList.contains("date-range")
              ...
              : "{}",
            r = _objectSpread(
              _objectSpread(_objectSpread({}, { disableMobile: "true" }), n),
              r,
            );
          flatpickr(e[t], r);
        }
    ...
    (function () {
      for (
        var o = document.querySelectorAll('[data-bs-toggle="select"]'), a = 0;
        a < o.length;
        a++
      )
        !(function () {
          for (
            var e = o[a].querySelectorAll(".dropdown-item"),
              t = o[a].querySelector(".dropdown-toggle-label"),
              r = o[a].querySelector('input[type="hidden"]'),
              n = 0;
            n < e.length;
            n++
          )
