        ...
        <div class="d-md-flex justify-content-between align-items-center text-center text-md-start p-4">
            <div class="d-md-flex align-items-center">
                <div class="img-thumbnail rounded-circle position-relative flex-shrink-0 mx-auto mb-2 mx-md-0 mb-md-0" style="width: 6.375rem;">
                    <span class="badge position-absolute end-0 mt-n2 fs-6" data-bs-toggle="tooltip" title="Reward points">❤️</span>
                    <img class="rounded-circle" src="img/shop/account/default.png" alt="<?= $_SESSION['user']['first_name'] ?>">
                </div>
                <div class="ps-md-3">
